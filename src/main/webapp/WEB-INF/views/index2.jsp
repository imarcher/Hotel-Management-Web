		...
		<div class="container-fluid">
			<div class="col-xs-2" id="left">
				...
				<div class="col-xs-12" id="l2">
					<a class="nav-link" href="http://localhost:8080/ssmdemo/manager/roominfo" target="_blank" ><span>房间信息</span></a>
				</div>
				<div class="col-xs-12" id="l3">
					<a class="nav-link" href="http://localhost:8080/ssmdemo/manager/optionorders" target="_blank" ><span>退房/续订</span></a>
				</div>
				<div class="col-xs-12" id="l4">
					<a class="nav-link" href="http://localhost:8080/ssmdemo/manager/unfinishedorder" target="_blank"  ><span>未完成订单</span></a>
				</div>
				<div class="col-xs-12" id="l6">
					<a class="nav-link" href="http://localhost:8080/ssmdemo/manager/finishedorder" target="_blank"  ><span>已完成订单</span></a>
				</div>
				<div class="col-xs-12" id="l7">
					<a class="nav-link" href="http://localhost:8080/ssmdemo/manager/changemanager/${model.id}" target="_blank"  ><span>修改密码</span></a>
				</div>

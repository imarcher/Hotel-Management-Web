...
<body background="/ssmdemo/img/bd652aeda622043c6766c88020f3e8d1.jpg">
	<div class="container">
		<div class="col-xs-12" id="top" >
			...
			<center><h1><b><i>修&nbsp &nbsp改&nbsp &nbsp管&nbsp &nbsp理&nbsp &nbsp员&nbsp &nbsp密&nbsp &nbsp码</i></b></h1></center>
		</div >
			<div class="col-xs-9">
				
			</div>
		<div class="col-xs-3" id="login_table"">
		<form action="http://localhost:8080/ssmdemo/manager/updatemanager/${model}" method="post">
			<div class="col-xs-12" id="t1">
			<center>新密码：<input type="password" id="password" name="password" style="width: 200px;height:30px"/><span id="e1"></span></center><br>
